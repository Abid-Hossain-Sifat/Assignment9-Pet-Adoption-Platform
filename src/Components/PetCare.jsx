...
const PetCare = () => {
  return (
    <div className="bg-[#dee4e1] py-16 md:py-24">
      <div className="max-w-[80%] mx-auto flex flex-col gap-12 md:gap-16">
        <div className="text-center max-w-xl mx-auto flex flex-col items-center gap-3">
          <span className="bg-[#fea619]/10 text-amber-700 font-extrabold text-[11px] uppercase tracking-widest px-3 py-1 rounded-full border border-amber-600/10">
            Expert Advice
          </span>
          <h1 className="text-3xl md:text-[40px] font-extrabold text-slate-900 tracking-tight mt-1">
            Pet Care Tips
          </h1>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch justify-center">
          <div className="bg-[#f5faf8] p-7 rounded-[24px] flex flex-col gap-4 shadow-sm border border-slate-200/40 hover:border-[#00685f]/20 hover:bg-white hover:shadow-[0_20px_40px_rgba(0,104,95,0.05)] hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer group">
            ...
            <div className="space-y-2">
              <h3 className="text-slate-800 font-extrabold text-[17px] tracking-tight">
                Balanced Nutrition
              </h3>
